...
export function BulkActionBar({ selectedCount, totalCount, onDelete, onPublish, onSelectAllPages }) {
  if (selectedCount === 0) {
    return null;
  }

  const canSelectMore = totalCount != null && selectedCount < totalCount;
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[#184D47]/20 bg-[#184D47]/5 px-4 py-3">
      ...
      <div className="flex flex-wrap items-center gap-2">
        {onSelectAllPages && canSelectMore ? (
          <DashboardButton variant="secondary" size="sm" onClick={onSelectAllPages}>
