...
export const DashboardPotentialsNew = lazy(() => import('@/dashboard/pages/PotentialNewPage'));
export const DashboardPotentialsEdit = lazy(() => import('@/dashboard/pages/PotentialEditPage'));
export const DashboardPotentialsDetail = lazy(() => import('@/dashboard/pages/PotentialDetailAdminPage'));
...
export const FeatureShowcaseDemo = lazy(() => import('@/pages/FeatureShowcaseDemo'));
