...
export function TablePagination({ page, pageSize, totalItems, onPageChange }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-[20px] border border-[#E8ECEA] bg-white px-5 py-3 text-[0.8125rem] text-neutral-500 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
      <span>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="rounded-lg border border-[#E8ECEA] bg-white px-3 py-1 text-[0.8125rem] font-medium text-neutral-700">
          {page}/{totalPages}
        </span>
