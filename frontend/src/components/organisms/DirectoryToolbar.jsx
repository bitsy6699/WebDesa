      ...
      >
        <div className="flex flex-col gap-3 md:flex-row md:items-center">
          <div className="relative flex-1">
            <div className="flex min-h-[56px] items-center rounded-full border border-white/70 bg-white/25 px-4 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.35)] transition-all duration-200 ease-out focus-within:border-primary/20 focus-within:bg-white/35 focus-within:shadow-[0_10px_30px_rgba(24,77,71,0.12)] focus-within:ring-2 focus-within:ring-[--border-focus] focus-within:ring-offset-2">
              <Search className="mr-3 h-5 w-5 shrink-0 text-neutral-500" />
              <input
                ref={searchInputRef}
                type="text"
                ...
                className="w-full border-none bg-transparent text-[15px] text-primary outline-none placeholder:text-neutral-500/65"
              ...
              {localSearch && (
                <button
                  type="button"
                  onClick={handleClear}
                  className="ml-2 rounded-full p-1.5 text-neutral-500 transition-colors hover:bg-black/5 focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2"
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              {isCategoryOpen && (
                <div className="absolute left-0 top-full z-20 mt-2 w-full min-w-[220px] origin-top overflow-hidden rounded-[24px] border border-white/70 bg-white/80 p-2.5 shadow-[0_20px_50px_rgba(15,61,52,0.14)] backdrop-blur-[24px]">
                  <button
                    ...
                    className={`flex w-full items-center justify-between rounded-[16px] px-3 py-2.5 text-left text-sm font-medium transition-all duration-200 focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 ${
                      activeCategory === null
                        ? 'bg-primary text-white shadow-[0_10px_24px_rgba(24,77,71,0.16)]'
                        : 'text-primary hover:bg-primary/8 hover:text-primary-dark'
                    }`}
                  >
                  ...
                  {categories.map((cat) => {
                    ...
                    return (
                      <button
                        ...
                        className={`mt-1 flex w-full items-center justify-between rounded-[16px] px-3 py-2.5 text-left text-sm font-medium transition-all duration-200 focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 ${
                          isActive
                            ? 'bg-primary text-white shadow-[0_10px_24px_rgba(24,77,71,0.16)]'
                            : 'text-primary hover:bg-primary/8 hover:text-primary-dark'
                        }`}
            ...
            {onReset && (
              <button
                ...
                className="h-[48px] rounded-full border border-transparent px-4 text-sm font-semibold text-neutral-500 transition-all duration-200 ease-out hover:-translate-y-[1px] hover:bg-white/30 hover:text-primary focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 sm:h-[52px]"
              >
                Reset
              </button>
            )}
            ...
            <button
              type="submit"
              className="h-[48px] rounded-full bg-primary px-5 text-sm font-semibold text-white shadow-[0_8px_20px_rgba(24,77,71,0.16)] transition-all duration-200 ease-out hover:-translate-y-[1px] hover:bg-primary-dark hover:shadow-[0_10px_24px_rgba(24,77,71,0.18)] focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 sm:h-[52px]"
            >
              Cari
            </button>
          </div>
